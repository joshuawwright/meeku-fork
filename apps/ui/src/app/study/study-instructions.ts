export const STUDY_INSTRUCTIONS = `Throughout this experiment, you will be presented with two sets of letter sequences, one at the top portion of
...
Your participation has to be done in one sitting. Typically, participation takes 10 minutes but sometimes exceeds 45 minutes to
complete. To successfully complete quickly, it is recommended that you minimize sources of distraction while
